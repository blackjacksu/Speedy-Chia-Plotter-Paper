...
\title{Chia Network and Proof of Space Acceleration by GPU}
%%
...
The fundamental of chia plot generation is based on two hash functions, chacha8 and blake3, where chacha8 is used in the gerneration of the first table and blake3 is used in generation of the rest 6 tables. 
{\bf Table 1}
The generation of the table 1 required iteration through the entire entries with value up to $2^{k} - 1$.
% \begin{figure}[ht]
% \begin{center}
